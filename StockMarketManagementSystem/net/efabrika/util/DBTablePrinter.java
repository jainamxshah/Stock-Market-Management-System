        ...
        try {
            ...
            for (Column c : columns) {
              ...
              // Center the column label
                ...
                toPrint = "\u001B[38;5;208m"+"| "+"\u001B[34m" + padding + name + padding + " ";
            ...
            //System.out.println("\u001B[38;5;208m"+info+"\u001B[0m");

            // Print out the formatted column labels
            System.out.print("\u001B[34m"+strToPrint.toString()+"\u001B[0m");
            ...
            for (int i = 0; i < rowCount; i++) {
                for (Column c : columns) {
                    ...
                    format = String.format("\u001B[34m"+"| %%%s%ds "+"\u001B[0m", c.getJustifyFlag(), c.getWidth());
                    System.out.print(
                            String.format("\u001B[38;5;208m"+format+"\u001B[0m", c.getValue(i))
                    );
                }

                System.out.println("\u001B[38;5;208m"+"|"+"\u001B[0m");
                System.out.print("\u001B[38;5;208m"+rowSeparator+"\u001B[0m");
            }
